  ...
  <div class="bg-gray">
    <div class="container">
     ...
     <div class="col-xl-4 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-4 px-4"><img src="images/products.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      
            <a href="{{url('/products')}}" style="text-decoration: none; font-weight: bold ; font-size: 25px;" class="mb-2">Products</a>
        </div>
    </div>
    <!-- End -->
           ...
           <!-- page item -->
           <div class="col-xl-4 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-4 px-4"><img src="images/employess.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          
                <a href="{{url('/empolyee')}}" style="text-decoration: none; font-weight: bold ; font-size: 25px;" class="mb-2">Employees</a>
            </div>
        </div>
        <!-- End -->
         <!-- page item -->
         <div class="col-xl-4 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-4 px-4"><img src="images/clients.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- End -->
       <!-- page item -->
       <div class="col-xl-4 col-sm-6 mb-5">
              <div class="bg-white rounded shadow-sm py-4 px-4"><img src="images/Sales.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
     ...
     <!-- page item -->
     <div class="col-xl-4 col-sm-6 mb-5">
      <div class="bg-white rounded shadow-sm py-4 px-4"><img src="images/reports.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
    
          <a href="{{url('/report')}}" style="text-decoration: none; font-weight: bold ; font-size: 25px;" class="mb-2">Reports</a>
      </div>
    </div>
    <!-- End -->

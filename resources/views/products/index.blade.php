...
<section class="ftco-section ">
    ...
    <script>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        ...
                        @csrf 
                        <input typy="text" name ="keyword"> <br>
                        <button type="submit">SEARCH</button>
                            ...
                            <div class="col-sm-4">
                                ...
                                <!-- <a href="{{url('/products/$product->id')}}" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						 -->
                            </div>
                        </div>
                    </div>
        ...
        <!-- Edit Modal HTML -->
        <div id="editProductModal" class="d-none">
            <div class="modal-dialog">
                <div class="modal-content">
                    @if($errors->any())
                    @foreach( $errors->all() as $error)
                    ...
                    @endforeach
                    @endif
                <form action='{{url("/products/$product->id")}}' method="post" class="form-edit" enctype="multipart/form-data ">
                        @csrf
                        @method("PUT")
                        <input type='text' name="id" hidden id="p-id"/>

                        <div class="modal-header">						
                            <h4 class="modal-title">EDIT PRODUCTE</h4>
                            <button type="button" class="close close-update" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">					
                            <div class="form-group">
                                <label> Product Name</label>
                            ...
                            <div class="form-group">
                                <label>Category</label>
                                <input type="text"  name="cat" id="p-cat" class="form-control" required >
                            </div>		
                            <div class="form-group">
                                <label>Price</label>
                            ...
                            <div class="form-group">
                                <label>Number OF pieces</label>
                                <input type="number" class="form-control" id="p-count"  name="count" required >
                            </div>					
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default close-update" data-dismiss="modal" value="Cancel">
